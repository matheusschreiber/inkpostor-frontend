                            ...
                            <div className="animate-in zoom-in-95 duration-200 fade-in flex flex-col items-center">
                                {amIImpostor ? (
                                    ...
                                    <>
                                        ...
                                        <p className="text-emerald-200/80 font-medium mb-1 uppercase tracking-widest text-sm">The word is</p>
                                        <h3 className="text-4xl font-black text-white">{secretWord}</h3>
